...
//    }
    ...
    public ResponseEntity<Response> submitAssignment(HttpServletRequest request, @RequestBody List<MemberEditAssignmentDto> memberList) throws JsonProcessingException {
